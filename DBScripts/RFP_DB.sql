...
INSERT INTO `customer` VALUES  (1,'ACC01','ACCENTURE','49','NIKESH@MAHINDRA.COM','NIKESH','94849484985','EXP23232','5.00','A',1,'2016-03-08 13:09:38',5,'2016-03-14 18:04:11'),
...
--
-- Definition of table `rfpcustomer`
--

DROP TABLE IF EXISTS `rfpcustomer`;
CREATE TABLE `rfpcustomer` (
  `RFPID` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `CUSTOMERID` int(10) unsigned NOT NULL,
  `ADDRESS` varchar(500) NOT NULL,
  `CONTACTPERSON` varchar(100) NOT NULL,
  `CONTACTNO` varchar(30) NOT NULL,
  `CASHACCOUNTID` varchar(100) NOT NULL,
  `TOTALSPEND` decimal(18,2) NOT NULL,
  PRIMARY KEY (`RFPID`,`CUSTOMERID`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `rfpcustomer`
--

/*!40000 ALTER TABLE `rfpcustomer` DISABLE KEYS */;
INSERT INTO `rfpcustomer` VALUES  (1,11,'THANE','dfdg','345','dgfdg','34.00'),
 (13,24,'THANE','dfdg','345','dgfdg','34.00'),
 (14,24,'THANE','dfdg','345','dgfdg','34.00'),
 (15,24,'THANE','dfdg','345','dgfdg','34.00');
/*!40000 ALTER TABLE `rfpcustomer` ENABLE KEYS */;
...
INSERT INTO `rfpheader` VALUES  (1,'RX0001','','2016-01-17 00:00:00',2,6,'700000.00','2016-01-17 14:18:21','1800-01-01 00:00:00',3,2,'40.00',2,'','','','','N','N','',0,'','','','','A',1,'2016-03-08 14:18:21',1,'2016-03-08 21:06:58'),
 ...
 (12,'RX000000011','dsff','2016-01-01 00:00:00',11,1,'0.00','2016-01-01 00:00:00','2016-01-01 00:00:00',1,1,'18.00',2,'45345','dfdsf','Inbound','','N','N','Volumetric',5,'PTPK','4545','rtre','6','A',1,'2016-03-14 20:31:57',0,'1800-01-01 00:00:00'),
 (13,'RX000000012','dsff','2016-01-01 00:00:00',1,1,'0.00','2016-01-01 00:00:00','2016-01-01 00:00:00',1,1,'18.00',2,'45345','dfdsf','Inbound','','N','N','Volumetric',5,'PTPK','4545','rtre','6','A',1,'2016-03-14 20:32:29',0,'1800-01-01 00:00:00'),
 (14,'RX000000013','dsff','2016-01-01 00:00:00',11,1,'0.00','2016-01-01 00:00:00','2016-01-01 00:00:00',1,1,'18.00',2,'45345','dfdsf','Inbound','','N','N','Volumetric',5,'PTPK','4545','rtre','6','A',1,'2016-03-14 20:33:31',0,'1800-01-01 00:00:00'),
 (15,'RX000000014','dsff','2016-01-01 00:00:00',24,0,'0.00','2016-01-01 00:00:00','2016-01-01 00:00:00',1,1,'18.00',2,'45345','dfdsf','Inbound','','N','N','Volumetric',5,'PTPK','4545','rtre','6','A',1,'2016-03-14 20:35:26',0,'1800-01-01 00:00:00');
...
CREATE TABLE `rfptransaction` (
  ...
  `UPDATEDBY` int(10) unsigned NOT NULL DEFAULT '0',
  `UPDATEDON` datetime NOT NULL DEFAULT '1800-01-01 00:00:00',
  `BANAME` varchar(100) DEFAULT NULL,
...
INSERT INTO `rfptransaction` VALUES  (1,1,20,2,10,2,'EXP','700000.00','700000.00','700000.00','700000.00','17000.00','16000.00','N','0.00','10000.00','A',1,'2016-03-08 14:54:46',1,'2016-03-14 23:30:24','IVC'),
 (2,1,20,4,7,5,'EXP','500000.00','500000.00','500000.00','20000.00','220000.00','20000.00','N','0.00','500000.00','A',1,'2016-03-08 14:54:46',0,'1800-01-01 00:00:00',NULL),
 (3,2,10,4,7,4,'EXP','600000.00','600000.00','600000.00','30000.00','400000.00','30000.00','N','0.00','600000.00','A',1,'2016-03-08 14:54:46',0,'1800-01-01 00:00:00',NULL),
 (4,1,20,3,18,1,'EXP','400000.00','400000.00','400000.00','250000.00','200000.00','250000.00','N','0.00','400000.00','A',1,'2016-03-08 14:54:46',0,'1800-01-01 00:00:00',NULL),
 (5,3,18,5,3,3,'EXP','300000.00','300000.00','300000.00','10000.00','20000.00','10000.00','N','0.00','300000.00','A',1,'2016-03-08 14:54:46',0,'1800-01-01 00:00:00',NULL),
 (6,2,10,4,7,1,'ORD','800000.00','800000.00','800000.00','20000.00','30000.00','20000.00','N','0.00','800000.00','A',1,'2016-03-08 14:54:46',0,'1800-01-01 00:00:00',NULL),
 (7,3,18,1,20,4,'ORD','600000.00','600000.00','600000.00','10000.00','500000.00','10000.00','N','0.00','600000.00','A',1,'2016-03-08 14:54:46',0,'1800-01-01 00:00:00',NULL),
 (8,4,7,2,10,3,'ORD','600000.00','600000.00','600000.00','30000.00','40000.00','30000.00','N','0.00','600000.00','A',1,'2016-03-08 14:54:46',0,'1800-01-01 00:00:00',NULL),
 (9,5,3,3,18,1,'AIR','400000.00','400000.00','400000.00','10000.00','30000.00','10000.00','N','0.00','400000.00','A',1,'2016-03-08 14:54:46',0,'1800-01-01 00:00:00',NULL),
 (10,3,18,5,3,4,'AIR','300000.00','300000.00','300000.00','20000.00','30000.00','20000.00','N','0.00','300000.00','A',1,'2016-03-08 14:54:46',0,'1800-01-01 00:00:00',NULL);
...
BEGIN
    ...
    IF (_MODE = 'INSERT') THEN
        ...
        ELSE
            INSERT INTO CUSTOMER(CUSTOMERCODE, CUSTOMERNAME, ADDRESS, CONTACTPERSON, EMAIL, CONTACTNO, CASHACCOUNTID,
              TOTALSPEND, CREATEDBY, ACTIVE)
              VALUES(_CUSTOMERCODE, _CUSTOMERNAME, _ADDRESS, _CONTACTPERSON, _EMAIL, _CONTACTNO, _CASHACCOUNTID,
              _TOTALSPEND, _CREATEDBY, 'A');
...
BEGIN
    ...
    ELSEIF(_MODE = 'GETALL') THEN
        SELECT L.LOCATIONID, L.LOCATIONCODE, L.LOCATIONNAME, L.ACTIVE, S.STATEID, S.STATENAME
          FROM LOCATION L
            INNER JOIN STATE S ON S.STATEID = L.STATEID WHERE L.ACTIVE = 'A';
...
BEGIN
    ...
    ELSEIF(_MODE = 'DELETE') THEN
        ...
        UPDATE RFPTRANSACTION SET ACTIVE = 'I', UPDATEDBY = _CREATEDBY, UPDATEDON = SYSDATE() WHERE RFPID = _RFPID AND FROMLOCATION = _FROMLOCATION AND TOLOCATION = _TOLOCATION
                    AND VEHICLETYPEID = _VEHICLETYPEID AND FROMSTATEID = _FROMSTATEID AND TOSTATEID = _TOSTATEID;
...
BEGIN
    ...
    IF (_MODE = 'INSERT') THEN
        ...
        ELSE
              ...
              INSERT INTO RFPHEADER(RFPCODE, RFPDATE, CUSTOMERID, INDUSTRYTYPEID, RFPAMOUNT, STARTDATE,
                    ...
                    ACTIVE, CREATEDBY)
                VALUES(@RFPCODE, _RFPDATE, _CUSTOMERID, _INDUSTRYTYPEID, _RFPAMOUNT, _STARTDATE,
              ...
              SET @RFPID = (SELECT RFPID FROM RFPHEADER WHERE RFPCODE = @RFPCODE LIMIT 1);

              INSERT INTO RFPCUSTOMER(RFPID, CUSTOMERID, ADDRESS, CONTACTPERSON, CONTACTNO, CASHACCOUNTID, TOTALSPEND)
                  VALUES(@RFPID, _CUSTOMERID, _ADDRESS, _CONTACTPERSON, _CONTACTNO, _CASHACCOUNTID, _TOTALSPEND);
              ...
              SELECT RH.RFPID, RH.RFPCODE, RH.RFPDATE, RH.CUSTOMERID, RH.INDUSTRYTYPEID, RH.RFPAMOUNT, RH.STARTDATE,
                  ...
                  RC.ADDRESS, RC.CONTACTPERSON, RC.CONTACTNO, RC.CASHACCOUNTID, RC.TOTALSPEND
              FROM RFPHEADER RH
                  INNER JOIN CUSTOMER C ON C.CUSTOMERID = RH.CUSTOMERID
                  INNER JOIN RFPCUSTOMER RC ON RC.RFPID = RH.RFPID
...
BEGIN
    ...
    ELSEIF(_MODE = 'APPROVED') THEN
        UPDATE RFPTRANSACTION SET APPROVEDAMOUNT = _APPROVEDAMOUNT, BANAME = _BANAME, ACTIVE = _ACTIVE, UPDATEDBY = _CREATEDBY, UPDATEDON = SYSDATE()
              WHERE RFPID = _RFPID AND FROMLOCATION = _FROMLOCATION AND TOLOCATION = _TOLOCATION
                    AND VEHICLETYPEID = _VEHICLETYPEID AND FROMSTATEID = _FROMSTATEID AND TOSTATEID = _TOSTATEID;
    ...
    ELSEIF(_MODE = 'APIRATE') THEN
        SET @BACKHAULAVL = 'N';
        IF(_BACKHAULPERCENT>0) THEN
            SET @BACKHAULAVL = 'Y';
        END IF;

        UPDATE RFPTRANSACTION SET SHIPXRATE = _SHIPXRATE, CONTRACTRATE = _CONTRACTRATE, CLEANSHEETRATE = _CLEANSHEETRATE,
              PVSRFPRATE = _PVSRFPRATE, BACKHAULPERCENT = _BACKHAULPERCENT, BACKHAULAVL = @BACKHAULAVL,
              ACTIVE = 'A', UPDATEDBY = _CREATEDBY, UPDATEDON = SYSDATE()
          WHERE RFPID = _RFPID AND FROMLOCATION = _FROMLOCATION AND TOLOCATION = _TOLOCATION
                    AND VEHICLETYPEID = _VEHICLETYPEID AND FROMSTATEID = _FROMSTATEID AND TOSTATEID = _TOSTATEID;
    ...
    ELSEIF(_MODE = 'BYRFPID') THEN
        SELECT RT.RFPID, RT.FROMLOCATION, RT.TOLOCATION, RT.VEHICLETYPEID, RT.SERVICETYPE,
            ...
            RT.ACTIVE, FL.LOCATIONNAME AS FROMLOCATIONNAME, TL.LOCATIONNAME AS TOLOCATIONNAME, RT.BANAME,
            VT.VEHICLETYPENAME, RT.FROMSTATEID, RT.TOSTATEID, FS.STATENAME AS FROMSTATE, TS.STATENAME AS TOSTATE,
            RC.ADDRESS, RC.CONTACTPERSON, RC.CONTACTNO, RC.CASHACCOUNTID, RC.TOTALSPEND, C.CUSTOMERNAME
        FROM RFPTRANSACTION RT
            INNER JOIN RFPCUSTOMER RC ON RC.RFPID = RT.RFPID
            INNER JOIN CUSTOMER C ON C.CUSTOMERID = RC.CUSTOMERID
            INNER JOIN LOCATION FL ON FL.LOCATIONID = RT.FROMLOCATION
            INNER JOIN STATE FS ON FS.STATEID = RT.FROMSTATEID
            INNER JOIN LOCATION TL ON TL.LOCATIONID = RT.TOLOCATION
            INNER JOIN STATE TS ON TS.STATEID = RT.TOSTATEID
            INNER JOIN VEHICLETYPE VT ON VT.VEHICLETYPEID = RT.VEHICLETYPEID
        WHERE RT.RFPID = _RFPID;

    ELSEIF(_MODE = 'PENDING') THEN
        SELECT RT.RFPID, RT.FROMLOCATION, RT.TOLOCATION, RT.VEHICLETYPEID, RT.SERVICETYPE,
            RT.CLEANSHEETRATE, RT.CONTRACTRATE, RT.SHIPXRATE,
            RT.PVSRFPRATE, RT.MARKETRATE, RT.BAQUOTE, RT.BACKHAULAVL, RT.BACKHAULPERCENT, RT.APPROVEDAMOUNT,
            RT.ACTIVE, FL.LOCATIONNAME AS FROMLOCATIONNAME, TL.LOCATIONNAME AS TOLOCATIONNAME, RT.BANAME,
...
BEGIN
    ...
    ELSEIF(_MODE = 'LOGIN') THEN
        ...
        WHERE USERCODE = _USERCODE AND `PASSWORD` = _PASSWORD;
